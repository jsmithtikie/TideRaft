 ...
 * This file demonstrates how to integrate Tideraft with a web frontend
 */

// For React/Vue/Angular applications
export class TideraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TideraftClient(provider, contractAddress);
